...
echo System-MAP-H | gmx_mpi trjconv -f ../../1-refinement/3-Map-Scaling/step3_input_xtc.pdb -s ../0-Production/rep-00/production.tpr -n ../../1-refinement/0-Building/index.ndx -o conf_map.pdb
